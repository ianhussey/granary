---
title: "Process Bainbridge et al.'s (2022) data"
author: "Ian Hussey"
...
labels_all <- read_rds("../../../data/bainbridge et al. 2022/raw/label.rds")
...
write_csv(s1_labels, "../../../data/bainbridge et al. 2022/processed/study 1 full text of scale items.csv")
write_csv(s2_labels, "../../../data/bainbridge et al. 2022/processed/study 1 full text of scale items.csv")
write_csv(s3_labels, "../../../data/bainbridge et al. 2022/processed/study 1 full text of scale items.csv")
...
names_all <- read_rds("../../../data/bainbridge et al. 2022/raw/scalenames.rds")
...
write_csv(scale_names, "../../../data/bainbridge et al. 2022/processed/scale abbreviations and full names.csv")
...
# study 1
data_s1 <- read_csv("../../../data/bainbridge et al. 2022/raw/s1.csv") |>
  janitor::clean_names() |>
  select(-x1,
         -unused_1,
         -unused_2,
...
data_s2 <- read_csv("../../../data/bainbridge et al. 2022/raw/s2.csv") |>
  janitor::clean_names() |>
  select(-x1,
         -unused_1,
         -unused_2,
...
data_s3 <- read_csv("../../../data/bainbridge et al. 2022/raw/s3.csv") |>
  janitor::clean_names() |>
  select(-x1,
...
write_csv(data_combined_demographics, "../../../data/bainbridge et al. 2022/processed/data_processed_demographics.csv")
...
# data_combined_itemlevel_wide <- data_combined_itemlevel |>
#   # pivot back to wide format
#   pivot_wider(names_from = c(scale, subscale, item),
#               values_from = response,
#               names_sep = "_") 
# 
# write_csv(data_combined_itemlevel_wide, "../../../data/bainbridge et al. 2022/processed/data_processed_itemlevel_wide.csv")


scale_names_simple <- scale_names |>
  filter(is.na(subscale)) |>
  select(-subscale) |>
  bind_rows(
    tibble(scale = c("ip", "bfi"),
           scale_name = c("IPIP_personality", "BFI_personality"))
  )

data_combined_itemlevel_long <- data_combined_itemlevel |>
  # add scale names
  left_join(scale_names_simple, by = "scale") |>
  select(-scale) |>
  rename(scale = scale_name) |>
  mutate(subscale = str_remove(subscale, "[:digit:]")) |>
  ...
  mutate(source = "Bainbridge") |>
  # Likert items are integer by convention; drop any non-integer responses so
  # downstream analyses can rely on response %in% seq(min_response, max_response).
  filter(response == round(response))

write_csv(data_combined_itemlevel_long, "../../../data/bainbridge et al. 2022/processed/data_processed_bainbridge_itemlevel_long.csv")
